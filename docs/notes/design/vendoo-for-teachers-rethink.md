...
| D12 | Yes. The probe runs read-only from the founder's own accounts: on their own Windows machine for the WebView2 half, and on Linux WebKitGTK for the indicative half. It gates the desktop client, and nothing is committed to that surface before it answers. | 2026-09-02, host settled 2026-09-03 |
