...
export const SETTINGS_ARE_A_PREVIEW =
	'A preview of the schedule settings. Nothing here is switched on, and nothing here is ' +
	'saved yet.';
...
export const SCHEDULE_BODY =
	'Your marketplaces are only ever reached from your own computer, signed in as you, so the ' +
	'timer runs there too. Setting it from here is not built yet.';
